/**
 * 使用自定义插件的 Logger 配置示例 (JavaScript 版本)
 */
import {
  createLogger,
  ConsoleTransport,
...
import { VisibilityIntegration } from './plugins/visibility-integration.js';
import { LocalStorageTransport } from './plugins/local-storage-transport.js';
...
export const logger = createLogger({
  app: 'plugin-example',
  env: (typeof process !== 'undefined' && process.env && process.env.NODE_ENV) || 'development',
  release: '1.0.0',
  level: 'debug',
